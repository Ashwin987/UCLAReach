...
type EventTicketsNavigationProp = StackNavigationProp<RootStackParamList, 'EventTickets'>;

type Props = {
    navigation: EventTicketsNavigationProp;
};

const EventTicketsScreen: React.FC<Props> = ({ navigation }) => {
    return (
