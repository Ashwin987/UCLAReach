...
type ServiceListingsScreenNavigationProp = StackNavigationProp<RootStackParamList, 'ServiceListings'>;
type ServiceListingsScreenRouteProp = RouteProp<RootStackParamList, 'ServiceListings'>;

type Props = {
    navigation: ServiceListingsScreenNavigationProp;
    route: ServiceListingsScreenRouteProp;
};

const ServiceListingsScreen: React.FC<Props> = ({ navigation }) => {
    return (
